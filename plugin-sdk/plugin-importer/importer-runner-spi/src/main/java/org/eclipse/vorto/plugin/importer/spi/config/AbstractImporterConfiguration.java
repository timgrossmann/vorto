 ...
 */
package org.eclipse.vorto.plugin.importer.spi.config;
...
public abstract class AbstractImporterConfiguration implements IImporterConfiguration {

  private static final String LOCALHOST = "localhost";
  private static final Logger LOGGER =
      LoggerFactory.getLogger(AbstractImporterConfiguration.class);
  ...
  public String getVortoRepoUrl() {
    ...
    throw new IllegalArgumentException("Not able to get the Vorto Server URL both from the "
        + "Environment variable VORTO_REPO_URL or the config setting 'vorto.serverUrl'");
  }
  ...
  public String getAppServiceUrl() {
    ...
    throw new IllegalArgumentException("Not able to get the Application Service URL both from the "
